        ...
        <div className="  footer-container3">
          <div className="footer-container2 ">
            ...
            <a
              ...
              <a className="flex  gap-1 text-gray-500  cursor-pointer" href="/courses">
                <p className="text-xl">Курсы</p>
                <GoArrowUpRight className="w-5 h-5 text-gray-500" />
              </a>
            </div>
            <div className="footer-item2">
            <a className="flex  gap-1 text-gray-500 cursor-pointer" href="/branches">
         ...
         <div className="flex items-center gap-1 text-gray-500 ">
            ...
            <div className="footer-box3 "><p className="text-white text-3xl  font-bold max-w-32">
              Социальные сети
            </p>
          ...
          <div className="footer-bottom border-t border-white pb-3">
            <p className="text-xl mt-6 ml-12 text-gray-500">
